...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "METAL_SLUG_X_RECOMP_PROJECT_ROOT",
    .build_dir_env = "METAL_SLUG_X_RECOMP_BUILD_DIR",
    .force_setup_env = "METAL_SLUG_X_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.12_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Metal_Slug_X__Recompiled",
    .prepare_note =
